...
from marketing_tool_lead_manager_app.forms import LeadForm,UpdateLocationFrom,LeadCommentForm,Login_Time_form,UpdateLocationTo,Logout_Time_form,CustomUserForm
...
def user_login(request):
    render(request, 'marketing_tool_lead_manager_app/index.html')
...
def user_sign_out(request):
    return render(request, 'marketing_tool_lead_manager_app/index.html')
#</-------Authentications Views ---------------------->
...
def company_lead_form(request):
    ...
    login_time_list = Login_Time.objects.all()
    logout_time_list = Logout_Time.objects.all()
    data = { 'pickup_locations' :pickup_locations,'login_time_list' :login_time_list,'logout_time_list' : logout_time_list}
